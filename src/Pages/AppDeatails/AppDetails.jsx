...
const AppDetails = () => {
  ...
  const { image, title, description, companyName, ratingAvg, downloads,reviews,size, ratings} =
    singleApp;
    ...
    <div className="bg-gray-50">
      <div className="w-11/12 mx-auto pt-8 pb-6">
        <div className="flex gap-5">
          <div>
            <img className="h-40 roundded" src={image} alt={title} />
          </div>
          {/* Right Side */}
